...
def main():
    ...
    from telegram.ext import PreCheckoutQueryHandler, MessageHandler, filters as msg_filters
    app.add_handler(PreCheckoutQueryHandler(handle_precheckout_query))
    app.add_handler(MessageHandler(msg_filters.SUCCESSFUL_PAYMENT, handle_successful_payment))
