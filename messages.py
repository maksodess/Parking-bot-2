...
LANG = {
    "bg": {
        ...
        "btn_all": "📋 Всичко наведнъж",
        
        # === ДЕЙСТВИЯ ===
        "action_buy": "🛒 Купува",
        "action_sell": "💰 Продава",
        "action_rent": "🔑 Наем",
        "action_lease": "📋 Под наем",
        ...
        "search_radius_500m": "500 м",
        "search_radius_1km": "1 км",
        "search_radius_2km": "2 км",
...
# Дополнительные переводы для недостающих ключей
LANG["bg"].update({
    "subscriptions_empty": "🔔 Нямате активни абонаменти.\n\nАбонаментите позволяват получаване на известия за нови обяви.",
    "ad_address_prompt": "✏️ Въведете *адрес на обекта*:\n\nНапример: _ул. Цар Симеон I 15_",
    "ad_geo_prompt": "📍 Изпратете геолокация на обекта чрез бутона по-долу.\n\nИли въведете адрес ръчно.",
    "ad_address_retry": "✏️ Въведете адрес отново:",
    "ad_geo_send": "📍 Изпратете точна геолокация чрез 📎 → Геолокация:",
    "ad_price_prompt": "💰 Въведете *цена* (число, €):",
    "error_number": "❌ Въведете число, например: 5000",
    "ad_photo_upload": "📸 Изпратете до 5 снимки *наведнъж* (незадължително)\n\n• Изпратете всички снимки едновременно\n• Или натиснете «Готово»",
    "ad_photo_or_skip": "📸 Изпратете снимки или натиснете *Пропускане*:",
    "edit_price_prompt": "💰 Въведете нова *цена* (число, €):",
    "edit_desc_prompt": "📝 Въведете ново *описание*\nИли «-» за да премахнете:",
    "edit_photo_prompt": "📸 Изпратете нови снимки (до 5)\nИли «-» за да премахнете:",
    "search_address_input": "✏️ Въведете *вашия адрес*:\n\nНапример: _ул. Цар Симеон I 15_\n\nБотът ще го намери на картата и ще предложи радиус за търсене.",
    "search_geo_input": "📍 Изпратете вашата геолокация:\n\n• Натиснете бутона «Изпращане на моята геолокация» по-долу\n• Или въведете адрес ръчно",
    "edit_address_prompt": "📍 Въведете нов *адрес*:",
    "edit_phone_prompt": "📞 Въведете нов *телефон* (или «-» за да премахнете):",
    "edit_value_prompt": "Въведете нова стойност:",
})

LANG["ru"].update({
    "subscriptions_empty": "🔔 У вас нет активных подписок.\n\nПодписки позволяют получать уведомления о новых объявлениях.",
    "ad_address_prompt": "✏️ Введите *адрес объекта*:\n\nНапример: _ул. Царь Симеон I 15_",
    "ad_geo_prompt": "📍 Отправьте геолокацию объекта через кнопку ниже.\n\nИли введите адрес вручную.",
    "ad_address_retry": "✏️ Введите адрес заново:",
    "ad_geo_send": "📍 Отправьте точную геолокацию через 📎 → Геолокация:",
    "ad_price_prompt": "💰 Введите *цену* (число, €):",
    "error_number": "❌ Введите число, например: 5000",
    "ad_photo_upload": "📸 Отправьте до 5 фотографий *одновременно* (необязательно)\n\n• Отправьте все фото одновременно\n• Или нажмите «Готово»",
    "ad_photo_or_skip": "📸 Отправьте фотографии или нажмите *Пропустить*:",
    "edit_price_prompt": "💰 Введите новую *цену* (число, €):",
    "edit_desc_prompt": "📝 Введите новое *описание*\nИли «-» чтобы удалить:",
    "edit_photo_prompt": "📸 Отправьте новые фотографии (до 5)\nИли «-» чтобы удалить:",
    "search_address_input": "✏️ Введите *ваш адрес*:\n\nНапример: _ул. Царь Симеон I 15_\n\nБот найдёт его на карте и предложит радиус для поиска.",
    "search_geo_input": "📍 Отправьте вашу геолокацию:\n\n• Нажмите кнопку «Отправить мою геолокацию» ниже\n• Или введите адрес вручную",
    "edit_address_prompt": "📍 Введите новый *адрес*:",
